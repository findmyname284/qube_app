...
import 'package:qube/screens/news/widgets/optimized_network_image.dart';

class FancyPromoCard extends StatelessWidget {
  final Promotion promo;
  final VoidCallback onTap;
  final int indexSeed;

  const FancyPromoCard({
    super.key,
    required this.promo,
    required this.onTap,
      ...
      child: AnimatedContainer(
        ...
        child: Stack(
          children: [
            ...
            if (hasImage)
              Positioned.fill(
                child: OptimizedNetworkImage(imageUrl: promo.imageUrl!),
              ),
